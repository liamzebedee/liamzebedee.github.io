I've taken inspiration from Medium to structure my CSS. Here is the guide I've adapted from the original Medium guide.

I've noted that it's hard to semantically structure CSS such that is it pretty/readable and still valid (as only a [few chars are valid as CSS selectors](http://stackoverflow.com/questions/448981/what-characters-are-valid-in-css-class-selectors)). 
